 ...
 */
declare interface ManifestTypeV3 {
    manifest_version: 3;
    name: string;
    version: string;
...
declare interface DeclarativeNetRequestResource {
    id: string;
    enabled: boolean;
    path: string;
}

declare interface WebAccessibleResourceByMatch {
    matches: string[];
    resources: string[];
    use_dynamic_url?: boolean;
}

declare interface WebAccessibleResourceById {
